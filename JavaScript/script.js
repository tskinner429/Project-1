if (window.location.href.includes =( 'targetedworkouts.html')) { // if statement to only run if on the targetedworkouts.html
    var workoutlist = {
        // created a object of functions so i could call them easily later in the code
        arm: function () {
            let options = {
                method: 'GET',
                headers: {
            ...
            fetch(url, options).then(function (response) {
                ...
                for (var i = 0; i < 10; i++) {
                    var armtitle = data[i].name // goes in the array provided by the api
